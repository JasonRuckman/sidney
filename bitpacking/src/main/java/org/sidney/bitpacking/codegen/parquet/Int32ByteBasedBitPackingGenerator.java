package org.sidney.bitpacking.codegen.parquet;
...
public class Int32ByteBasedBitPackingGenerator {
    ...
    private static void generateScheme(String className, boolean msbFirst, String basePath) throws IOException {
        ...
        fw.append("package org.sidney.bitpacking;\n\n");
        for (int i = 0; i <= PACKER_COUNT; i++) {
            fw.append(String.format("import org.sidney.bitpacking.packers.%s.int32.Packer" + i + ";\n", (msbFirst) ? "be" : "le"));
        }
        fw.append("\n");
        fw.append("/**\n");
        if (msbFirst) {
        ...
        for (int i = 0; i <= PACKER_COUNT; i++) {
            ...
            sb.append(String.format("package org.sidney.bitpacking.packers.%s.int32;\n", (msbFirst) ? "be" : "le"));
            sb.append("\n");
            sb.append("import org.sidney.bitpacking.Int32BytePacker;");
            sb.append("\n");
