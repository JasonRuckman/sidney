...
public class LongByteBasedBitPackingGenerator {
    ...
    private static void generateScheme(String className, boolean msbFirst, String basePath) throws IOException {
        ...
        fw.append(" * @see LongByteBasedBitPackingGenerator\n");
        fw.append(" *\n");
        fw.append(" */\n");
    ...
    private static void generatePack(FileWriter fw, int bitWidth, int batch, boolean msbFirst) throws IOException {
        ...
        fw.append("    public final void pack" + (batch * 8) + "Values(final long[] in, final int inPos, final byte[] out, final int outPos) {\n");
    ...
    private static void generateUnpack(FileWriter fw, int bitWidth, int batch, boolean msbFirst)
        throws IOException {
        fw.append("    public final void unpack" + (batch * 8) + "Values(final byte[] in, final int inPos, final long[] out, final int outPos) {\n");
        if (bitWidth > 0) {
            int mask = genMask(bitWidth);
