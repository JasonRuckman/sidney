...
public class Factories {
  ...
  public Factories(Configuration conf) {
    this.conf = conf;
  }
  ...
  /**
   * Get a instance factory for this type, if none is found {@link com.github.jasonruckman.sidney.core.serde.factory.DefaultInstanceFactory}
   */
