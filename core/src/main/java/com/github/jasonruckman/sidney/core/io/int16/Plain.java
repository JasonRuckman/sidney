...
public class Plain {
  public static class PlainShortDecoder extends IndirectDecoder implements ShortDecoder {
    @Override
    ...
    public short[] nextShorts(int num) {
      return input.readShorts(num);
    }
  }

  public static class PlainShortEncoder extends IndirectEncoder implements ShortEncoder {
    @Override
