...
public class BitPacking {
  public static class BitPackingCharDecoder extends DirectDecoder implements CharDecoder {
    ...
    public char nextChar() {
      ...
      return (char) currentMiniBlock[currentIndex++];
    }
  ...
  public static class BitPackingCharEncoder extends DirectEncoder implements CharEncoder {
    ...
    public BitPackingCharEncoder() {
      this(DEFAULT_BLOCK_SIZE);
    }

    public BitPackingCharEncoder(int miniBlockSize) {
    ...
    public void writeChar(char value) {
      currentMiniBlock[currentIndex++] = value & 0xFFFF;
