...
public class PrimitiveSerializer extends Serializer {
  ...
  static {
    ...
    TYPES.put(Boolean.class, Type.BOOLEAN);
    TYPES.put(byte.class, Type.INT32);
    TYPES.put(Byte.class, Type.INT32);
    TYPES.put(int.class, Type.INT32);
    TYPES.put(Integer.class, Type.INT32);
    TYPES.put(short.class, Type.INT32);
    TYPES.put(Short.class, Type.INT32);
    TYPES.put(char.class, Type.INT32);
    TYPES.put(Character.class, Type.INT32);
    TYPES.put(long.class, Type.INT64);
    TYPES.put(Long.class, Type.INT64);
    TYPES.put(float.class, Type.FLOAT32);
    TYPES.put(Float.class, Type.FLOAT32);
