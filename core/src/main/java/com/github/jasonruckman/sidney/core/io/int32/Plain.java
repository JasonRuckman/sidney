...
public class Plain {
  public static class PlainInt32Decoder extends IndirectDecoder implements Int32Decoder {
    @Override
    public int nextInt() {
  ...
  public static class PlainInt32Encoder extends IndirectEncoder implements Int32Encoder {
    @Override
