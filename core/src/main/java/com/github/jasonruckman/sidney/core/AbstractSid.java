...
public class AbstractSid {
  private Configuration conf = Configuration.newConf();
  ...
  /**
   * Sets the number of records buffered before flush to output stream
   * @param pageSize
   */
  ...
  public void setIOType(Configuration.IOType type) {
    conf.setType(type);
  }
