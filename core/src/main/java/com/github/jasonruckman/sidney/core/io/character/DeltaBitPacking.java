...
public class DeltaBitPacking {
  public static class DeltaBitpackingCharEncoder extends DirectEncoder implements CharEncoder {
    ...
    public void writeChar(char value) {
      ...
      prevValue = value;
      currentMiniBlock[currentIndex++] = delta & 0xFFFF;
  ...
  public static class DeltaBitpackingCharDecoder extends DirectDecoder implements CharDecoder {
    ...
    public char nextChar() {
      ...
      return (char) intBuffer[currentIndex++];
    }
