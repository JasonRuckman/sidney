...
public class Plain {
  public static class ByteArrayDecoder extends IndirectDecoder implements BytesDecoder {
    @Override
  ...
  public static class ByteArrayEncoder extends IndirectEncoder implements BytesEncoder {
    @Override
