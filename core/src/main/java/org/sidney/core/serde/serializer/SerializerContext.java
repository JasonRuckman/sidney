...
public interface SerializerContext {
    /**
     * Create a new serializer given a {@link org.sidney.core.TypeRef}
    ...
    /**
     * Create a new serializer given a {@link org.sidney.core.TypeRef} with the given {@link org.sidney.core.serde.serializer.Serializer} as a parent.
     * Unless you are the root serializer, this is the call to use for custom serialization
     * @param typeRef the type ref
     * @param parent type of serializer
     * @param <T> type of serializer
     * @return an initialized serializer with the given {@link org.sidney.core.serde.serializer.Serializer} as the parent.
     */
